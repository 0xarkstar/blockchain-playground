...
const track = getTrackByKey("appliedZk")!;
      ...
      <div className="flex flex-col gap-8">
        <div className="relative overflow-hidden rounded-xl border bg-card p-8 mb-8">
          ...
          <div className="relative z-10 flex flex-col items-center text-center gap-4">
            ...
            <div className="w-full max-w-md mt-2">
              <TrackProgressBar trackKey="appliedZk" showLabel />
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {track.demos.map((demo, i) => {
            const completed = isComplete("appliedZk", demo.slug);
